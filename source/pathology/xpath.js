    ...
    __consume__location_step: function(input) {
      ...
      if (address1) {
        ...
        if (address2) {
          ...
          var index9 = this._offset, elements3 = [], labelled3 = {}, text3 = "";
          var address8 = null;
          var slice2 = null;
          if (this._input.length > this._offset) {
          ...
          if (address8) {
            ...
            var address9 = null;
            address9 = this.__consume__space();
            if (address9) {
              elements3.push(address9);
              text3 += address9.textValue;
              labelled3.space = address9;
              var address10 = null;
              address10 = this.__consume__integer();
              if (address10) {
                elements3.push(address10);
                text3 += address10.textValue;
                labelled3.integer = address10;
                var address11 = null;
                address11 = this.__consume__space();
                if (address11) {
                  elements3.push(address11);
                  text3 += address11.textValue;
                  labelled3.space = address11;
                  var address12 = null;
                  var slice4 = null;
                  if (this._input.length > this._offset) {
                  ...
                  if (slice4 === "]") {
                    ...
                    var type7 = null;
                    address12 = new klass7("]", this._offset, []);
                    if (typeof type7 === "object") {
                      extend(address12, type7);
                    }
                    this._offset += 1;
                  } else {
                    address12 = null;
          ...
          if (elements3) {
            ...
            var type8 = null;
            address7 = new klass8(text3, this._offset, elements3, labelled3);
          ...
          if (address7) {
            ...
            var type9 = null;
            address7 = new klass9("", this._offset, []);
          ...
          if (address7) {
            ...
            labelled0.subscript = address7;
            var address13 = null;
            var remaining0 = 0, index10 = this._offset, elements4 = [], text4 = "", address14 = true;
            while (address14) {
              address14 = this.__consume__node_predicate();
              if (address14) {
            ...
            if (remaining0 <= 0) {
              ...
              var type10 = null;
              address13 = new klass10(text4, this._offset, elements4);
              if (typeof type10 === "object") {
                extend(address13, type10);
              }
            ...
            if (address13) {
              ...
              labelled0.predicates = address13;
            } else {
              elements0 = null;
              this._offset = index1;
            }
      ...
      if (elements0) {
        ...
        var type11 = find(this.constructor, "LocationStep");
        address0 = new klass11(text0, this._offset, elements0, labelled0);
